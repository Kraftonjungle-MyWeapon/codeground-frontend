...
const WaitingRoomListCard = ({ waitingRooms, onCreateRoom, onJoinRoom, onLoadMore, hasMore }: Props) => {
    const roomsToShow = hasMore ? waitingRooms.slice(0, waitingRooms.length - 1) : waitingRooms;
