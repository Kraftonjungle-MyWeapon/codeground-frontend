...
import { Upload, User, Code, Trophy, ArrowRight, SkipForward } from 'lucide-react';
...
const ProfileSetupPage = () => {
  ...
  const programmingLanguages = [
    ...
    'Go', 'Rust', 'Kotlin', 'Swift', 'TypeScript', 'Ruby'
  ];
        ...
        <div className="max-w-md mx-auto">
          <CyberCard glowing className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">추가 정보를 설정해보세요 (선택사항)</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => setFormData(prev => ({ ...prev, programmingLanguage: value }))}>
                  ...
                  <SelectContent className="bg-cyber-darker border-gray-600">
                    {programmingLanguages.map((lang) => (
                      <SelectItem key={lang} value={lang} className="text-white hover:bg-cyber-blue/20">
                        {lang}
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => setFormData(prev => ({ ...prev, solvedacTier: value }))}>
                  <SelectTrigger className="w-full bg-black/20 border-gray-600 text-white">
                    <div className="flex items-center space-x-2">
                  ...
                  <SelectContent className="bg-cyber-darker border-gray-600">
                    {solvedacTiers.map((tier) => (
                      <SelectItem key={tier} value={tier} className="text-white hover:bg-cyber-blue/20">
                        {tier}
                      </SelectItem>
                    ))}
                  </SelectContent>
